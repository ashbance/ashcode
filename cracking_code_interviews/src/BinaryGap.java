...
public class BinaryGap {
    ...
    public static void main(String[] args) {
        int res =  solution(1041);
        int res2 =  solutionWithoutSplit(1041);
        System.out.println("longest number of zeros is " + res2);
    }
    ...
    private static int solutionWithoutSplit(int N) {
